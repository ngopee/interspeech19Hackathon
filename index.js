...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    return handlerInput.responseBuilder
      .speak('Welcome to Recycler. I will recommend the best job for you. Do you want to start your career or be a couch potato?')
      .reprompt('What do you want to recycle?')
      .getResponse();
  },
};
